...
export default function ({ navigation, route }) {
    ...
    const __sendServer = () => {
        ...
        setTimeout(() => {
            axios.post(urlAPI + '/1add_transaksi2.php', kirim).then(res => {
    ...
    return (
        <SafeAreaView style={{
            ...
            {!loading && <MyButton onPress={__sendServer} title="Send Request" Icons="cloud-upload-outline" warna={colors.secondary} />}
