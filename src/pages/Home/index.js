  ...
  return (
    <SafeAreaView
      ...
      <View style={{
        ...
        <DataKategori onPress={() => navigation.navigate('AddSatu', user)} nama="Request" nama2="Laptop" icon="laptop-outline" />
        <DataKategori onPress={() => navigation.navigate('AddDua', user)} nama="Request" nama2="Component" icon="grid-outline" />
